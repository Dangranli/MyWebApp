...
public class UserController {
    ...
    @PostMapping("/users/savedeposit")
    public String saveUserDeposit(User user, RedirectAttributes ra) {
    ...
    public String saveUserWithdraw(User user, RedirectAttributes ra) {

        if (user.getMoneyForWithdraw() <= user.getBalance() && user.getMoneyForWithdraw() > 0) {
